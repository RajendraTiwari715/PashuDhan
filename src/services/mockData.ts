import type { Animal, Complaint, QRTag, DepartmentInfo } from '../types';
...
export const INITIAL_BLANK_TAGS: QRTag[] = [
...
export const REGIONAL_PASU_VIBHAG: DepartmentInfo[] = [
  {
...
export const REGIONAL_POLICE_STATIONS: DepartmentInfo[] = [
  {
...
export const REGIONAL_GAUSHALAS: DepartmentInfo[] = [
  {
